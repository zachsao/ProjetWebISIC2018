<!-- Navigation -->	
	<nav class="navbar navbar-expand-lg navbar-light bg-light static-top">
		<div class="col-2">
			<a class="navbar-brand" href="index.php?controller=admin&action=accueil">CarCar Binks</a>
		</div>
		<div class="collapse navbar-collapse col-10 justify-content-end" id="navbarLinks">
			...
			<a href="?controller=admin&action=profilGestionUser" ><button type="button" class="btn btn-outline-secondary">Gestion des utilisateurs</button></a>
